...
const Login = () => {
  return (
    <div className="min-h-screen flex bg-slate-950 font-sans text-slate-300">
      ...
      {/* Left Panel - Multiplayer Branding */}
      <div className="hidden lg:flex w-1/2 bg-slate-900 relative overflow-hidden flex-col justify-between p-12 border-r border-slate-800">
        ...
        <div className="relative z-10">
          <div className="w-12 h-12 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-xl flex items-center justify-center shadow-lg shadow-blue-900/20 mb-6">
            <span className="text-white font-bold text-xl">W</span> {/* W for Workspace */}
          </div>
          <h1 className="text-4xl font-bold text-white mb-4 tracking-tight">
            Welcome back to the <br/>
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-emerald-400">Shared Workspace</span>
          </h1>
          <p className="text-slate-400 max-w-md text-lg">
            Pick up right where you left off. Your team and your AI assistant are already online.
          </p>
        </div>

        {/* Live Team Status Mockup */}
        <div className="relative z-10 bg-slate-950/50 p-6 rounded-2xl border border-slate-800 backdrop-blur-sm">
           <div className="flex items-center gap-3 mb-2">
             ...
             <p className="text-sm font-medium text-slate-300">Project Alpha is active</p>
           </div>
           <p className="text-xs text-slate-400">Sarah and the AI Agent are currently editing <code className="text-blue-300">server.js</code></p>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12 relative">
        <div className="w-full max-w-md">
          ...
          <div className="mb-10 text-center lg:text-left">
            ...
            <p className="text-slate-400">Enter your details to rejoin your team.</p>
          </div>
